...
<section id="speciality" class="cell grid-x grid-margin-x">
    <h2 class="cell large-6 medium-8">Spécialitées :</h2>
    <ul class="large-11 medium-11 small-6 grid-x grid-margin-x large-up-3 medium-up-3">
        <li class="cell">Radiographie</li>
        <li class="cell">Echographie</li>
        <li class="cell">Analyses sanguines</li>
        <li class="cell">Laboratoire et cytologie</li>
        <li class="cell">Dentisterie</li>
        <li class="cell">Chirurgie</li>
        <li class="cell">Hospitalisation</li>
        <li class="cell">Service de garde 24h/24 -7j/7</li>
    </ul>
    <div class="large-1 medium-1 small-3 large-offset-0 medium-offset-0 small-offset-3">
        <img id="chabada" src="../img/chat-Bada.png" alt="Chat Bada la mascotte de CAT CLINIC" />
    </div>
</section>
HERE;
