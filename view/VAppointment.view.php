...
<article id="grid-x-one" class="grid-y grid-margin-y" aria-label="rendez-vous">
    ...
    <div class="cell large-10 grid-x grid-margin-x large-margin-collapse medium-margin-collapse small-margin-collapse app-box">
        ...
        <section id="appBoxMailList" class="cell large-4 medium-4 small-8" data-sticky-container aria-live="polite" aria-relevant="removals">
            <h2 class="appBox-menu-header bordered">$listTitle</h2>
            <ul id="mailList">
                $li
            </ul>
        </section>
        <section id="appBoxMailReader" class="cell large-auto medium-auto small-12" aria-live="polite" aria-relevant="all">
