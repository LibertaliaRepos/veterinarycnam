...
<div class="grid-x">
    <header id="banner" class="cell medium-11 large-11 grid-x">
            <a class="cell" href="../php/" title="Accueil"><img  id="logo" src="../img/catclinic_v2.3.2.png" alt="Logo de CAT CLINIC" /></a>
    </header>
    <nav class="small-12 medium-11 large-11 grid-container header-menu">
        <ul class="grid-x grid-margin-x small-up-2 dropdown menu" data-dropdown-menu>
