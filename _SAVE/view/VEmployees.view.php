...
<!--                    <label for="yearSelect" class="large-1">Année :</label>-->
                ...
                <textarea id="descriptionAera" name="DESCRIPTION" required>{$updateValues['description']}</textarea>
                ...
                <div id="pictureArea" class="cell grid-x grid-margin-x">
                    <div id="disablablePict" class="cell">
                        <label for="photoEmployInp" >Photo :</label>
                            ...
                            <img id="preview" class="" src="../upload/employees/{$updateValues['photo']}"  alt="Aperçu de la photo" />
                    </div>
