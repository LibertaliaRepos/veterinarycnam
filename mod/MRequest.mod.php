...
class MRequest{
    ...
    /**
     * Compte le nombre de tuples correspondant à un ou/et deux status.
     * 
     * @param int $_status1
     * @param int $_status2
     * @return mixed
    ...
    /**
     * Insertion d'une demande de rendez-vous.
     */
    ...
    /**
     * Mise à jour du status de la demande de rendez-vous.
     * 
    ...
    /**
     * Suppression d'une demande de rendez-vous.
     */
